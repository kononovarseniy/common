...
#include <ka/common/interval_set.hpp>
...
TEST(IntervalSetTest, size)
{
    ...
    EXPECT_EQ(size_t { 11u }, IntervalSet<s32>::make_greater_equal(IntervalValueTraits<s32>::max() - 10).size());
}
...
TEST(IntervalSetTest, no_builtin_operators_type)
{
    ...
    using TestRangeSet = IntervalSet<NoBuiltinOperatorsInt, IntervalValueTraits>;
